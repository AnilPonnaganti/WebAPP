...
export declare class ColumnComponent extends ColumnBase {
    ...
    field: string;
    /**
     * The format that is applied to the value before it is displayed. [See example](slug:filtering_grid#toc-date-filter). For more information on the supported date and number formats,
