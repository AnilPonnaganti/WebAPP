...
import * as i25 from "./rendering/toolbar/toolbar.component";
import * as i26 from "./pager/pager.component";
import * as i27 from "./grouping/group-panel.component";
import * as i28 from "./rendering/common/col-group.component";
import * as i29 from "./rendering/header/header.component";
import * as i30 from "./rendering/list.component";
import * as i31 from "./rendering/footer/footer.component";
import * as i32 from "./rendering/table-body.component";
import * as i33 from "./rendering/common/loading.component";
import * as i34 from "@progress/kendo-angular-icons";
import * as i35 from "./localization/localized-messages.directive";
import * as i36 from "@angular/common";
import * as i37 from "./column-resizing/table.directive";
import * as i38 from "./rendering/grid-table.directive";
import * as i39 from "./layout/resizable.directive";
import * as i40 from "@progress/kendo-angular-utils";
...
export class GridComponent {
    constructor(supportService, selectionService, cellSelectionService, wrapper, groupInfoService, groupsService, changeNotification, detailsService, editService, filterService, pdfService, responsiveService, renderer, excelService, ngZone, scrollSyncService, domEvents, columnResizingService, changeDetectorRef, columnReorderService, columnInfoService, navigationService, sortService, scrollRequestService, localization, ctx, sizingService, rowReorderService) {
         ...
         * Emits the [RowReorderEvent]({% slug api_grid_selectionevent %}#toc-selectionchange).
         */
...
GridComponent.ɵcmp = i0.ɵɵngDeclareComponent({ minVersion: "12.0.0", version: "13.3.12", type: GridComponent, selector: "kendo-grid", inputs: { data: "data", pageSize: "pageSize", height: "height", rowHeight: "rowHeight", detailRowHeight: "detailRowHeight", skip: "skip", scrollable: "scrollable", selectable: "selectable", sort: "sort", size: "size", trackBy: "trackBy", filter: "filter", group: "group", virtualColumns: "virtualColumns", filterable: "filterable", sortable: "sortable", pageable: "pageable", groupable: "groupable", rowReorderable: "rowReorderable", navigable: "navigable", navigatable: "navigatable", autoSize: "autoSize", rowClass: "rowClass", rowSticky: "rowSticky", rowSelected: "rowSelected", cellSelected: "cellSelected", resizable: "resizable", reorderable: "reorderable", loading: "loading", columnMenu: "columnMenu", hideHeader: "hideHeader", isDetailExpanded: "isDetailExpanded", isGroupExpanded: "isGroupExpanded" }, outputs: { filterChange: "filterChange", pageChange: "pageChange", groupChange: "groupChange", sortChange: "sortChange", selectionChange: "selectionChange", rowReorder: "rowReorder", dataStateChange: "dataStateChange", groupExpand: "groupExpand", groupCollapse: "groupCollapse", detailExpand: "detailExpand", detailCollapse: "detailCollapse", edit: "edit", cancel: "cancel", save: "save", remove: "remove", add: "add", cellClose: "cellClose", cellClick: "cellClick", pdfExport: "pdfExport", excelExport: "excelExport", columnResize: "columnResize", columnReorder: "columnReorder", columnVisibilityChange: "columnVisibilityChange", columnLockedChange: "columnLockedChange", columnStickyChange: "columnStickyChange", scrollBottom: "scrollBottom", contentScroll: "contentScroll" }, host: { properties: { "attr.dir": "this.dir", "class.k-grid": "this.hostClass", "class.k-grid-sm": "this.sizeSmallClass", "class.k-grid-md": "this.sizeMediumClass", "class.k-grid-lockedcolumns": "this.lockedClasses", "class.k-grid-virtual": "this.virtualClasses", "class.k-grid-no-scrollbar": "this.noScrollbarClass" } }, providers: [
        ...
        <ng-container *ngIf="isScrollable">
            ...
            <kendo-grid-list
                ...
                (press)="handleReorderEvents($event, 'press')"
                (dragStart)="handleReorderEvents($event, 'dragStart')"
                (drag)="handleReorderEvents($event, 'drag')"
                (dragEnter)="handleReorderEvents($event, 'dragEnter')"
                (dragLeave)="handleReorderEvents($event, 'dragLeave')"
                (dragEnd)="handleReorderEvents($event, 'dragEnd')"
                (drop)="handleReorderEvents($event, 'drop')"
                [dragData]="gridData"
                [data]="$any(view)"
                [rowHeight]="rowHeight"
