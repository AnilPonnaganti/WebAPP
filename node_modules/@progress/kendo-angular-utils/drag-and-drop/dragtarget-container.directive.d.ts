...
export declare class DragTargetContainerDirective implements AfterViewInit {
    ...
    /**
     * Specifies a selector for elements within each DragTarget which will be configured as drag handles ([see example]({% slug drag_target_container_handle %})).
     */
    dragHandle: string;
    /**
